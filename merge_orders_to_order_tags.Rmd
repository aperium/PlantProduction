...
# TODO clean up description. remove duplicate words, symbols, caps
...
# can i use dplyr::join with dplyr::closest() with pairwiseAligment scores? or maybei need to use fuzzyjoin
