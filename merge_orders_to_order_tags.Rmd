...
name_match <- function(x,y) {
  ...
  mapply(\(m,n) {str_equal(m,n,ignore_case = TRUE)|str_equal(joined_index$yname[match(m,joined_index$xname)],n,ignore_case = TRUE)},x,y)
}

name_match(mtag_orders$`MT Item Description`, mtag_orders$`MT Item Description`)
