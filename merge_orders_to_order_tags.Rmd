...
- [ ] read-in MasterTag orders list to subtract from need_to_order
...
tag_dir <- "Greenstreet Growers\TeamSite - Documents\Shared\Production Greenstreet\Production Planning QC\Tags\MasterTag" |> fs::path_home()

tag_orders <- tag_dir |> fs::path("GREENSTREET_GROWERS_INC_Order Export_03_06_2024.xlsx") |>
  read_xlsx_flex(guess_max = Inf)
