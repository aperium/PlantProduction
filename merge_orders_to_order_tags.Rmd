...
tags_filtered <- mtag_orders |>
  dplyr::filter(`Estimated Ship Date` > "20231201" |> ymd())
...
scores <- foreach(i=1:length(plant_names), .combine = rbind, .export = c("tag_names","plant_names")) %dopar% {
