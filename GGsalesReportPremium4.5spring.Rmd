...
CP_filtersummary <- CP_summary %>% 
  ...
  mutate(category = case_when(Description |> paste(`Long Desc`) |> str_to_lower() |> str_detect("(ipomo?(ea)?)|(potato[:space:]vine)") ~ "ipomea",
                              ...
                              Description |> paste(`Long Desc`) |> str_to_lower() |> str_detect("(secretia)|(pallida)") ~ "secretia",
                              ...
                              Description |> paste(`Long Desc`) |> str_to_lower() |> str_detect("dracena[:space:]((spike)|(indivisa))") ~ "dracena spike"))
