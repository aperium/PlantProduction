...
CP_filtersummary <- CP_summary %>% 
  ...
  mutate(category = case_when(Description |> str_detect(coll("strobilanthes")) ~ "strobilanthes",
                              Description |> str_detect(coll("(secretia)|(pallida)")) ~ "secretia",
                              Description |> str_detect(coll("duranta")) ~ "duranta",
                              Description |> str_detect(coll("lysmachia")) ~ "lysmachia",
                              Description |> str_detect(coll("vinca")&coll("vine")) ~ "vinca vine",
                              Description |> str_detect(coll("dracena")&(coll("spike")|coll("indivisa"))) ~ "dracena spike"))
