...
# output path
out_path <- "/Greenstreet Growers/TeamSite - Documents/Shared/Production Greenstreet/Production Planning QC/Plant Sales and Orders/" |> str_c(year(now())) |> fs::path_home()
...
CP_data %>%
  ...
  write_xlsx_flex(str_c("herbveg","2025","-sales-pred-v1.xlsx"))
