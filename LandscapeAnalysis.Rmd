...
if(!exists("dCluster")) {
  ...
  cluster_library(dCluster, installed_req_pkgs)
}
...
## These ifs check to see if the addresses have changed at all before bothering google. If there are changes, then google is querried. 
