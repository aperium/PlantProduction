...
dir_path <- "C:/Users/danielw/Greenstreet Growers/TeamSite - Documents/Shared/Production Greenstreet/Production Finished/QVC Spring 2024 Drop Ship/Sales Reports" |> path_home()

inventory_on_hand <- dir_path |> path("GM36_sku_inventory_2024-03-18.csv")
sales_by_daterange <- dir_path |> path("GM36_sku_sales_2024-03-14_through_2024-03-18.csv")
