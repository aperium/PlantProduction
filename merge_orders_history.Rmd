...
herbs <- list(
  ...
  Allium = c("Allium", "Chive", "Chives", "Garlic", "Leek", "Onion", "Scallion"),
  ...
  Salvia = c("Salvia", "Sage", "Salvia-Sage"),
  ...
  Artemisia = c("Artemisia", "Tarragon", "Mugwort"),
  ...
  Eucalyptus = c("Eucalyptus polyanthemos", "red box", "Eucalyptus ciner", "silver dollar", "Baby Blue", "Eucalyptus"),
...
vegetables <- list(
  ...
  Solanum = c("Solanum", "Tomato", "Eggplant", "Potato", "Pepper", "Tomatillo"),
  ...
  Cucurbita = c("Cucurbita", "Pumpkin", "Squash", "Zucchini", "Bitter Melon"),
  Apium = c("Apium", "Celery", "Celeriac"),
  Beta = c("Beta", "Beet", "Chard"),
  Rheum = c("Rheum", "Rhubarb"),
  Allium = c("Allium", "Onion", "Garlic", "Shallot", "Ramp"),
  Asparagus = c("Asparagus", "Asparagus"),
  Ipomoea = c("Ipomoea", "Sweet Potato"),
  ...
  Chayote = c("Chayote", "Chayote Squash"),
  ...
  Helianthus = c("Helianthus", "Jerusalem Artichoke"),
...
fruits <- list(
  ...
  Rubus = c("Rubus", "Raspberry", "Blackberry", "Boysenberry"),
  ...
  Syzygium = c("Syzygium", "Water Apple", "Java Apple"),
  ...
  Maracuja = c("Passiflora", "Passionfruit"),
...
annuals <- list(
  ...
  Impatiens = c("Impatiens", "Impatiens", "Busy Lizzie", "ImpaEX", "SunpatnsCmp"),
  Petunia = c("Petunia", "Petunia"),
  Pelargonium = c("Pelargonium", "Geranium"),
  Viola = c("Viola", "Pansy", "Viola"),
  Calendula = c("Calendula", "Calendula", "Pot Marigold"),
  Zinnia = c("Zinnia", "Zinnia"),
  Begonia = c("Begonia", "Begonia"),
  ...
  Portulaca = c("Portulaca", "Portulaca", "Moss Rose"),
  ...
  Verbena = c("Verbena", "Verbena"),
  Vinca = c("Vinca", "Vinca", "Periwinkle"),
  Lantana = c("Lantana", "Lantana"),
  Phlox = c("Phlox", "Phlox"),
  ...
  Clarkia = c("Clarkia", "Clarkia", "Farewell-to-Spring"),
  ...
  Gilia = c("Gilia", "Gilia", "Bird's Eye"),
  ...
  Petchoa = c("Petchoa", "SupCal", "Suprtn"),
  ...
  Mix = c("MixMaster","TrixiLiner", "Combo", "Mult-sp"),
...
perennials <- list(
  ...
  Rudbeckia = c("Rudbeckia", "Black-Eyed Susan"),
  Hosta = c("Hosta", "Hosta", "Plantain Lily"),
  Lavandula = c("Lavandula", "Lavender"),
  Phlox = c("Phlox", "Phlox"),
  ...
  Delphinium = c("Delphinium", "Delphinium", "Larkspur"),
  Iris = c("Iris", "Iris"),
  ...
  Aster = c("Aster", "Aster"),
  Helleborus = c("Helleborus", "Hellebore", "Lenten Rose"),
...
succulents <- list(
  Aloe = c("Aloe", "Aloe"),
  Agave = c("Agave", "Agave"),
  Echeveria = c("Echeveria", "Echeveria"),
  Crassula = c("Crassula", "Jade Plant"),
  Sedum = c("Sedum", "Stonecrop"),
  Kalanchoe = c("Kalanchoe", "Kalanchoe"),
  Haworthia = c("Haworthia", "Haworthia", "Zebra Plant"),
  ...
  Turbinicarpus = c("Turbinicarpus", "Turbinicarpus"),
...
foliage <- list(
  ...
  Ficus = c("Ficus", "Fiddle Leaf Fig", "Weeping Fig", "Rubber Plant"),
  Philodendron = c("Philodendron", "Philodendron"),
  Epipremnum = c("Epipremnum", "Pothos", "Devil's Ivy"),
  Spathiphyllum = c("Spathiphyllum", "Peace Lily"),
  Dracaena = c("Dracaena", "Dragon Tree", "Corn Plant"),
  Calathea = c("Calathea", "Prayer Plant"),
  Maranta = c("Maranta", "Prayer Plant"),
  Dieffenbachia = c("Dieffenbachia", "Dumb Cane"),
  Schefflera = c("Schefflera", "Umbrella Plant"),
  Alocasia = c("Alocasia", "Elephant Ear"),
  ...
  Aglaonema = c("Aglaonema", "Chinese Evergreen"),
  Aspidistra = c("Aspidistra", "Cast Iron Plant"),
  Codiaeum = c("Codiaeum", "Croton"),
  Anthurium = c("Anthurium", "Flamingo Flower"),
  ...
  Syngonium = c("Syngonium", "Arrowhead Plant"),
  Cordyline = c("Cordyline", "Ti Plant"),
  Beaucarnea = c("Beaucarnea", "Ponytail Palm"),
  Caladium = c("Caladium", "Caladium", "Elephant Ear"),
  Stromanthe = c("Stromanthe", "Tricolor Ginger"),
  Musa = c("Musa", "Banana Plant"),
  Tradescantia = c("Tradescantia", "Wandering Jew"),
  Araucaria = c("Araucaria", "Norfolk Island Pine"),
  Hedera = c("Hedera", "English Ivy"),
  Pothos = c("Epipremnum", "Golden Pothos", "Marble Queen Pothos"),
  Syngonium = c("Syngonium", "Nephthytis", "Arrowhead Vine"),
  Rhapis = c("Rhapis", "Lady Palm"),
  Ctenanthe = c("Ctenanthe", "Never Never Plant"),
  Rhoeo = c("Rhoeo", "Oyster Plant", "Moses-in-the-Cradle"),
  Caryota = c("Caryota", "Fishtail Palm"),
  Rhaphidophora = c("Rhaphidophora", "Mini Monstera"),
  Begonia = c("Begonia", "Rex Begonia", "Angel Wing Begonia"),
  Calocephalus = c("Calocephalus", "Silver Bush"),
  Pandanus = c("Pandanus", "Screw Pine"),
  Aspidistra = c("Aspidistra", "Cast Iron Plant"),
  Pilea = c("Pilea", "Aluminum Plant"),
  Soleirolia = c("Soleirolia", "Baby's Tears"),
  Neoregelia = c("Neoregelia", "Blushing Bromeliad"),
  Guzmania = c("Guzmania", "Guzmania Bromeliad"),
  Vriesea = c("Vriesea", "Flaming Sword Bromeliad"),
  Tillandsia = c("Tillandsia", "Air Plant"),
  Yucca = c("Yucca", "Yucca Cane"),
  ...
  Philodendron = c("Philodendron", "Heartleaf Philodendron"),
  Syngonium = c("Syngonium", "Arrowhead Plant"),
  Clivia = c("Clivia", "Kaffir Lily"),
  Aechmea = c("Aechmea", "Urn Plant"),
  Dracaena = c("Dracaena", "Song of India"),
  Epipremnum = c("Epipremnum", "Devil's Ivy", "Pothos"),
  Aglaonema = c("Aglaonema", "Chinese Evergreen")
) |> enframe() |>
  unnest(value) |>
  dplyr::rename("genus" = name, "common name" = value) |>
...
bulbs_tubers <- list(
  ...
  Crocus = c("Crocus", "Crocus"),
  Dahlia = c("Dahlia", "Dahlia"),
  Gladiolus = c("Gladiolus", "Gladiolus"),
  Lilium = c("Lilium", "Lily"),
  Hyacinthus = c("Hyacinthus", "Hyacinth"),
  Iris = c("Iris", "Iris"),
  Begonia = c("Begonia", "Tuberous Begonia"),
  Cyclamen = c("Cyclamen", "Cyclamen"),
  ...
  Erythronium = c("Erythronium", "Dog's Tooth Violet"),
...
trees_shrubs <- list(
  ...
  Rhododendron = c("Rhododendron", "Rhododendron"),
  Hydrangea = c("Hydrangea", "Hydrangea"),
  Camellia = c("Camellia", "Camellia"),
  Cornus = c("Cornus", "Dogwood"),
  Magnolia = c("Magnolia", "Magnolia"),
  Ilex = c("Ilex", "Holly"),
  Prunus = c("Prunus", "Cherry", "Plum"),
  Buxus = c("Buxus", "Boxwood"),
  Juniperus = c("Juniperus", "Juniper"),
  Viburnum = c("Viburnum", "Viburnum"),
  Berberis = c("Berberis", "Barberry"),
...
groundcovers <- list(
  ...
  Tiarella = c("Tiarella", "Foamflower"),
  Phlox_subulata = c("Phlox_subulata", "Creeping Phlox"),
  Lysimachia = c("Lysimachia", "Creeping Jenny"),
  Hosta = c("Hosta", "Plantain Lily"),
  Heuchera = c("Heuchera", "Coral Bells"),
  Fragaria = c("Fragaria", "Wild Strawberry"),
  Waldsteinia = c("Waldsteinia", "Barren Strawberry"),
...
bamboo <- list(
  ...
  Bambusa = c("Bambusa", "Clumping Bamboo"),
  Fargesia = c("Fargesia", "Clumping Bamboo"),
...
epiphytes <- list(
  Tillandsia = c("Tillandsia", "Air Plant"),
  Bromeliad = c("Bromeliad", "Bromeliad"),
...
carnivorous <- list(
  ...
  Brocchinia = c("Brocchinia", "Brocchinia"),
  Roridula = c("Roridula", "Roridula"),
...
seasonal <- list(
  ...
  Kalanchoe = c("Kalanchoe", "Kalanchoe"),
  Helleborus = c("Helleborus", "Christmas Rose", "Lenten Rose"),
  Viola = c("Viola", "Pansy", "Viola"),
  ...
  Solanum_pseudocapsicum = c("Solanum_pseudocapsicum", "Jerusalem Cherry"),
  Ardisia = c("Ardisia", "Coral Berry"),
  Aster = c("Aster", "Michaelmas Daisy"),
  Amaryllis_belladonna = c("Amaryllis_belladonna", "Naked Lady"),
  Camellia = c("Camellia", "Camellia"),
  Gardenia = c("Gardenia", "Gardenia"),
  Poinciana = c("Poinciana", "Royal Poinciana"),
  Alstroemeria = c("Alstroemeria", "Peruvian Lily"),
  Cyclamen_persicum = c("Cyclamen_persicum", "Florist's Cyclamen"),
  Crocus = c("Crocus", "Crocus"),
  Azalea = c("Rhododendron", "Azalea"),
  Gaillardia = c("Gaillardia", "Blanket Flower"),
  Celosia = c("Celosia", "Cockscomb"),
  Aster = c("Aster_novi-belgii", "New York Aster"),
  Salvia_farinacea = c("Salvia_farinacea", "Mealycup Sage"),
  Cineraria = c("Pericallis", "Florist's Cineraria"),
  Dianthus_caryophyllus = c("Dianthus_caryophyllus", "Carnation"),
  Amaranthus = c("Amaranthus", "Love-lies-bleeding"),
  Pennisetum_glaucum = c("Pennisetum_glaucum", "Purple Fountain Grass")
) |> enframe() |>
  unnest(value) |>
  dplyr::rename("genus" = name, "common name" = value) |>
...
other <- list(
  pot = c("pot", "coex", "Pressure Formed"),
  media = c("media"),
...
plants_classified <- plants_joined |>
  ...
  fuzzy_left_join(plant_classifications, by = c("Description" = "common name"), \(x,y) {str_detect(str_to_lower(x),str_c("(^|[:space:])",str_to_lower(y),"(((es)|s)?($|[:space:]))"))}) #|>
  # collect()
plants_classified |>
  filter(dept |> is.na()) |>
  view()
...
plants_filtered <- plants_joined |>
  partition(dCluster) |>
  dplyr::filter((`Ship Date` >= "20230701" |> ymd())&(`Ship Date` < "20240101" |> ymd()),
