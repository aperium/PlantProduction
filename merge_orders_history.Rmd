...
req_pkgs <- c("rlang", "magrittr", "tidyselect", "tidyverse", "lubridate", "stats", "readr", "measurements", "knitr", "plyr", "tidyr","bibtex","ggpubr","ggplot2", "firatheme", "gt", "ggpmisc", "foreach", "forcats", "doParallel", "parallel", "fs", "purrr", "janitor", "stringdist", "readxl", "writexl", "fuzzyjoin", "openxlsx", "xlsx", "pwr", "effectsize", "Biostrings")
#
...
dir_path <- "Greenstreet Growers/TeamSite - Documents/Shared/Production Greenstreet/Production Planning QC/Plant Sales and Orders" |> path_home()

e_orders <- dir_path |> path("Express Seed export","express_open_orders_20240228.xlsx") |>
  read_xlsx_flex(guess_max = Inf)

e_delivered <- dir_path |> path("Express Seed export","express_shipped_orders_20240228.xlsx") |>
  read_xlsx_flex(guess_max = Inf)

b_orders <- dir_path |> path("Ball export","order_download_20240228110813.xlsx") |>
  read_xlsx_flex(guess_max = Inf) |>
  mutate(vendor = "Ball",
...
e_combined <- dplyr::full_join(e_orders, e_delivered) |>
  select("Order #", "Customer PO #", "Order Date", "Ship Date", "Week", "Product #", "Description", "Supplier", "QTY Ordered") |>
...
alignment <- c("vendor" = "vendor", "Order #" = "Order Number","Customer PO #" = "PO Number", "Order Date" = "Sales Order Date", "Ship Date" = "Ship Date", "Week" = "Ship Week", "Product #" = "Ball Material Number", "Description" = "Variety", "Supplier" = "Supplier", "QTY Ordered" = "Quantity")
...
write_xlsx_flex(joined, path = "spring2024_ball&express_v4.xlsx")
```
