...
# 20241113 much faster now. moved all code to generate table into an external script. Loading externally much faster than reading in as text here.
...
plants_filtered <- plants_classified |>
  ...
  dplyr::filter(str_equal(type,"plug") | str_equal(type,"finished"),
                (`Ship Date` >= "20231101" |> ymd())&(`Ship Date` < "20250101" |> ymd()),
...
## I think there is a duplication issue when merging with the plant_classifications table TODO
